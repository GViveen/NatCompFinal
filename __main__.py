...
def main(use_simulated_data=False, create_new_file=False, num_generations=1000):
    ...
    if use_simulated_data:
        ...
        if create_new_file:
            g = Grid(80, simple_scenario=False)
    ...
    pop = utils.create_population_from_file(data_file, 0.1)
...
if __name__ == "__main__":
    main(use_simulated_data=True, create_new_file=True, num_generations=10000)